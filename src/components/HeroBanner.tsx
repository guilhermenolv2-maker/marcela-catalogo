...
export function HeroBanner() {
  return (
    <section className="relative overflow-hidden bg-ice">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-white/25 to-ink/20 sm:bg-gradient-to-r sm:from-white sm:via-white/82 sm:to-white/28" />
      ...
      <div className="relative mx-auto grid min-h-[720px] max-w-7xl content-center px-4 py-14 sm:min-h-[76vh] sm:px-6 sm:py-16 lg:px-8">
        <div className="max-w-sm rounded-3xl border border-white bg-white/[0.94] p-6 shadow-soft backdrop-blur-md sm:max-w-2xl sm:rounded-none sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none sm:backdrop-blur-none">
          ...
          <h1 className="font-display text-4xl font-semibold leading-tight text-ink sm:text-6xl lg:text-7xl">
            Marcela Lopes
          </h1>
          <p className="mt-5 max-w-xl text-base font-medium leading-7 text-ink sm:text-lg sm:leading-8 sm:text-ink/75">
